...
app.layout = html.Div(
    [
        html.Div(
            [
                # Navigation
                html.P("Welcome to the PredictO App!", className="start"),
                html.Div([
...
def update_data(n, val):  # inpur parameter(s)
    if n == None:
        return "Hey there! Please enter a legitimate stock code to get details.", "https://i.ibb.co/x6wqHBk/stonk-img.png", "PridictO", None, None, None
        # raise PreventUpdate
    else:
        if val == None:
            raise PreventUpdate
